# Deployment Script for PKPD with R Book
# This script renders the book and deploys to GitHub Pages
# Usage: .\deploy.ps1

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "PDPK with R Book Deployment" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Repository: https://github.com/vanhungtran/PDPKwithR.git" -ForegroundColor White
...
Write-Host "GitHub Pages URL: https://vanhungtran.github.io/PDPKwithR/" -ForegroundColor White
Write-Host ""
